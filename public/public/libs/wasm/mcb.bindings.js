...
export class MarchingCubes {
    ...
    * @param {number} dims_y
    * @param {number} dims_z
    * @param {number} data_scale
    * @param {number} data_offset
    * @param {boolean} scale_first
    * @param {number} undef
    * @param {number} undef_fill
    */
    set_volume(volume, dims_x, dims_y, dims_z, data_scale, data_offset, scale_first, undef, undef_fill) {
        var ptr0 = passArrayF32ToWasm0(volume, wasm.__wbindgen_malloc);
        var len0 = WASM_VECTOR_LEN;
        wasm.marchingcubes_set_volume(this.ptr, ptr0, len0, dims_x, dims_y, dims_z, data_scale, data_offset, scale_first, undef, undef_fill);
    }
    /**
